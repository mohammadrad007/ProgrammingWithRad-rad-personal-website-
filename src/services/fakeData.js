const Data = {
  posts: [
    ...
    },
    {
      ...
      postImageUrl:
        "https://hisupport.net/wp-content/uploads/2017/06/php7-upgrade-hisupport.jpg",
      postContent:
    ...
    },
    {
      ...
      postImageUrl: "https://i.udemycdn.com/course/750x422/913448_e6e2.jpg",
      postContent:
    ...
    },
    {
      ...
      postImageUrl:
        "http://www.wiadevelopers.com/wp-content/uploads/2018/12/%DA%86%D9%86%D8%AF-%D8%A7%D8%A8%D8%B2%D8%A7%D8%B1-%D8%A8%D8%B1%D9%86%D8%A7%D9%85%D9%87-%D9%86%D9%88%DB%8C%D8%B3%DB%8C-React.jpg",
      postContent:
    ...
    },
    {
      ...
      postImageUrl:
        "http://www.wiadevelopers.com/wp-content/uploads/2018/08/Redux.jpg",
      postContent:
        "سلام به شما کاربران عزیز و دوست داشتنی. امروز میخوام درباره Redux براتون مطلب بزارم. Redux یک کتابخانه جاوا اسکریپت متن باز برای مدیریت وضعیت برنامه است. Redux چیست؟ کتابخانه Redux یک کتابخانه JavaScript متن باز برای مدیریت وضعیت برنامه است که معمولا همراه با کتابخانه های React یا Angular برای ایجاد رابط کاربری استفاده می شود. Redux یک کتابخانه کوچک همراه با یک API ساده و محدود است که برای یک…",
      postTags: "ری_اکت ریداکس",
      like: 11
    },
    {
      id: 7,
      postTitle: "کمی در مورد vue js",
      postDate: "19 اردیبهشت 1398",
      postImageUrl:
        "https://ckeditor.com/blog/best-wysiwyg-editor-for-vue/feature.png",
      postContent:
        "Vue.js یکی از آن فن آوری های نرم افزاری جدید است که به طور گسترده ای در سراسر جهان برای توسعه وب استفاده می شود. Vue.js در واقع یک فریمورک جاوا اسکریپت با ابزار اختیاری مختلف برای ایجاد یک رابط کاربری مناسب است. در ادامه مزایای استفاده از تکنولوژی Vue.js در توسعه وب شرح داده شده است :دارای اندازه بسیار کوچکموفقیت فریمورک های جاوا اسکریپت به اندازه آن بستگی دارند. هر چقدر اندازه ی آنها کوچکتر باشد، بیشتر از آنها استفاده خواهد شد. یکی از بزرگترین مزایای Vue.js اندازه کوچک آن است. اندازه این چارچوب 18 تا 21 کیلوبایت است و زمان زیادی برای بارگیری و استفاده از آن تلف نخواهد شد.در این مورد این فریمورک ، تمام چارچوب های بزرگ مانند React.js، Angular.js و Ember.js را مغلوب کرده است.",
      postTags: "ویو_جی_اس",
      like: 14
    }
    // {
